...
export default {
    ...
    data(){
        ...
        return{
            ...
            rules: {
            name: [
            { required: true, message: '用户名不能为空' ,trigger:"blur"},{min:6,max:15,message:"长度在6字符-15字符之间",trigger:'blur'}
            ],
            email: [
            { type:"email",required: true, message: '邮箱格式不正确' ,trigger:"blur" }
            ],
            password: [
            { required: true,message:"密码不能为空",trigger: 'blur' },{min:6,max:15,message:"长度在6字符-15字符之间",trigger:'blur'}
            ],
             password2: [
             { required: true,message:"确认密码不能为空",trigger: 'blur' },
             {min:6,max:15,message:"长度在6字符-15字符之间",trigger:'blur'},
             {
